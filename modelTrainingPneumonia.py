...
train = get_training_data('classifier/data/chest_xray/chest_xray/train')
test = get_training_data('classifier/data/chest_xray/chest_xray/test')
val = get_training_data('classifier/data/chest_xray/chest_xray/val')
...
model.save('classifier/models/pneumonia.h5')
